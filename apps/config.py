...
class Config(object):
    ...
    # MOMO API
    MOMO_USERNAME = '0394803011'
    MOMO_PASSWORD = '09112035+-*/Bb'
    MOMO_TOKEN = 'B28D7C73-E179-B2AD-A825-82575C061CD1'
    MOMO_ACCOUNT_PHONE = '0394803011'
    MOMO_ACCOUNT_PASSWORD = '090909'
    MOMO_API = 'https://api.web2m.com/'
    MOMO_SESSION = os.environ.get('MOMO_SESSION')
    # MOMO_SESSION will be generated when initializing this application
